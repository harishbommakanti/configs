...
# ------------------------------------------------------------------------------
# modified by me for colors change mostly
#
...
#
repo_information() {
    echo "%F{cyan}${vcs_info_msg_0_%%/.} %F{magenta}$vcs_info_msg_1_`git_dirty` $vcs_info_msg_2_%f"
}
...
RPROMPT="%F{11}${SSH_TTY:+%n@%m}%f"    # Display username if connected via SSH
